...
def sample_target(im, target_bb, search_area_factor, output_sz=None, mask=None):
    ...
    if output_sz is not None:
        ...
        att_mask = cv.resize(att_mask, (output_sz, output_sz)).astype(bool)
        if mask is None:
        ...
        if mask is None:
            return im_crop_padded, att_mask.astype(bool), 1.0
        return im_crop_padded, 1.0, att_mask.astype(bool), mask_crop_padded
